        ...
        <div className="flex justify-between items-center ">
          ...
          <div className="links">
            <ul className="flex gap-5 text-gray-500">
              <li className="flex">
                Products <FaChevronDown className="relative top-2 left-1" />
              </li>
              <li className="flex">
                Platform <FaChevronDown className="relative top-2 left-1" />
              </li>
              <li>Track Order</li>
              <li className="flex">
                Resources <FaChevronDown className="relative top-2 left-1" />
              </li>
